...
class User extends Model {
	...
	const SESSION = "User";
	const SECRET_IV = 'senhatorecoveryw';
	...
	protected $fields = [
		"iduser", "idperson", "deslogin", "despassword", "inadmin", "dtergister", "nrphone", "desemail", "desperson"
	];
	...
	public static function login($login, $password):User
	{
		...
		$results = $db->select("SELECT * FROM tb_users a            
	...
	public static function setForgotUsed($idrecovery){
		...
		$sql->query(
			...
			SET dtrecovery = NOW() WHERE idrecovery = :idrecovery
			", array(
				":idrecovery"=>$idrecovery
			)
		);
	...
	public function setPassword($password){
		...
		$sql->query(
			"
			UPDATE tb_users
			SET despassword = :despassword WHERE iduser = :iduser
			", array(
    ...
    public static function getPage($page = 1, $itemsPerPage = 10){
        ...
        $results = $sql->select("
                    ...
                    FROM tb_users a 
                    JOIN tb_persons b USING(idperson) 
