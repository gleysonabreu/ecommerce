...
$app->get("/order/:idorder/pagseguro", function($idorder){
    ...
    $page->setTpl("payment-pagseguro", [
        ...
        "phone"=>[
            ...
            'number'=>substr($order->getnrphone(), 2, strlen($order->getnrphne()))
        ]
    ]);
...
$app->post("/profile", function (){
    ...
    if(!isset($_POST['desperson']) || $_POST['desperson'] === ''){
        User::setError("Preencha seu o nome");
        header("Location: /profile");
        exit;
    }
    if(!isset($_POST['desemail']) || $_POST['desemail'] === ''){
        User::setError("Preencha seu o e-mail");
        header("Location: /profile");
        exit;
    }
...
// DADOS DO SEU CLIENTE
    ...
    $dadosboleto["endereco1"] = $order->desaddress().", ".", ".$order->getdesnumber().", ".$order->getdesdistrict();
    $dadosboleto["endereco2"] = $order->getdescity().", ".$order->getdesstate().", ".", ".$order->getdescountry().",".$order->getdeszipcode();

// INFORMACOES PARA O CLIENTE
    $dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja WULF";
    $dadosboleto["demonstrativo2"] = "Taxa bancária - R$ 0,00";
    $dadosboleto["demonstrativo3"] = "";
    $dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
    $dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
    $dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: suporte@wulf.com";
    $dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto Loja WULF E-commerce - www.wulf.com";
